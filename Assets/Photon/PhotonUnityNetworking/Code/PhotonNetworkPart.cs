    ...
    public static partial class PhotonNetwork
    {
        ...
        public static float LevelLoadingProgress
        {
            get
            {
                ...
                {
                    _levelLoadingProgress = _AsyncLevelLoadingOperation.Value.PercentComplete;
...
#pragma warning restore 0414
        ...
        internal static void LoadLevelIfSynced()
        {
            ...
            if (sceneId is int)
            {
                throw new Exception("Invalid scene id. Cannot load using an int.");
        ...
        internal static void SetLevelInPropsIfSynced(object levelId)
        {
            ...
            if (_AsyncLevelLoadingOperation != null)
            {
                if (!_AsyncLevelLoadingOperation.Value.IsDone)
                {
